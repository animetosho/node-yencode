...
void encoder_vbmi2_init() {
	RapidYenc::_do_encode = &do_encode_simd< do_encode_avx2<ISA_LEVEL_VBMI2> >;
	encoder_avx2_lut<ISA_LEVEL_VBMI2>();
	RapidYenc::_encode_isa = ISA_LEVEL_VBMI2;
}
# else
#  include "encoder_sse_base.h"
void encoder_vbmi2_init() {
	RapidYenc::_do_encode = &do_encode_simd< do_encode_sse<ISA_LEVEL_VBMI2> >;
